    ...
    <div className="connect-bank-card">
      ...
      <div className="connect-bank-card-content">
        <p>
          ...
          transactions. All your financial data in one place - safe, secure, and
          private.
        </p>
        ...
        <div className="connect-bank-benefits">
          <div className="benefit-item">
            ...
            <div className="benefit-text">
              ...
              <p>
                Your transactions are imported automatically, so your dashboard
          ...
          <div className="benefit-item">
            ...
            <div className="benefit-text">
              ...
              <p>
                Your credentials are never stored. We use Plaid, trusted by
                millions of users.
              </p>
            </div>
          </div>
          ...
          <div className="benefit-item">
            ...
            <div className="benefit-text">
              <h4>Save Time</h4>
              <p>
                No more manual entry. Focus on analyzing your spending habits
                instead.
              </p>
            </div>
          </div>
...
const handleRemoveBank = async (bankId) => {
  if (
    ...
    try {
      await Request.post(`/plaid/items/${bankId}/unlink/`);
      fetchBanks();
  ...
  return (
    <div className="account-card">
      <div className="account-card-header">
        ...
        <div className="account-balance">{getBalanceText()}</div>
      </div>
...
const BankCard = ({ bank, onSync, onRemove, syncing }) => {
      ...
      {isExpanded && (
        <div className="bank-card-content">
          ...
          <div className="bank-card-actions">
            <button
              className="disconnect-bank-button"
              onClick={(e) => {
...
const BankConnectionPage = () => {
  ...
  return (
    <div className="bank-connection-page">
      ...
      {error && <div className="bank-connection-error">{error}</div>}
