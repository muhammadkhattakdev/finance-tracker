      ...
      <div className="budget-modal-container" ref={modalRef}>
        ...
        <form onSubmit={handleSubmit} className="budget-form">
          <div className="budget-form-intro">
            <p>Define how much you plan to spend in each period. We'll track your expenses against these budgets.</p>
          </div>
            ...
            {suggestWeekly && !budgets.weekly && (
              <div className="budget-suggestion">
                ...
                <button 
                  ...
                  onClick={() => handleChange({ target: { name: 'weekly', value: suggestWeekly } })}
                >
                  Use
                </button>
              </div>
            ...
            {suggestMonthly && !budgets.monthly && (
              <div className="budget-suggestion">
                ...
                <button 
                  type="button" 
                  className="use-suggestion" 
                  onClick={() => handleChange({ target: { name: 'monthly', value: suggestMonthly } })}
                >
                  Use
                </button>
              </div>
